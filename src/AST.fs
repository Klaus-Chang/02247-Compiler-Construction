...
and Pretype =
    ...
    | TMutableStruct of fields: List<bool * string * PretypeNode>    
...
and Expr<'E,'T> =
    ...
    | ArrayElementAssign of array: Node<'E, 'T> * index: Node<'E, 'T> * value: Node<'E, 'T>    
    ...
    | ForScoped of init: Node<'E, 'T> * cond: Node<'E, 'T> * update: Node<'E, 'T> * body: Node<'E, 'T>
    | ForEach of name: string * array: Node<'E, 'T> * body: Node<'E, 'T>  
    //When parameters are passed from the Parser to this AST constructor, the following occurs:
    //New AST Node Creation: A new AST node of type ForScoped is created.
    //Storing Child Nodes: The four passed parameters (init, cond, update, body) are stored as child nodes of this new ForScoped node.
    //'E and 'T are generic parameters representing environment information and type information respectively. 
    //This structure preserves the four key parts of the loop, 
    //making it easy for subsequent analysis and transformation operations to access these parts.
    ...
    | MutableStructExpr of fields: List<bool * string * Node<'E,'T>>
